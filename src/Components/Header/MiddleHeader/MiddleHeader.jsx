...
const MiddleHeader = () => {
  ...
  const { myListCount, fetchMyList }        = useContext(StoreContext);
              ...
              <div className="hidden lg:block relative" ref={dropdownRef}>
                {isLoggedIn ? (
                  <>
                    ...
                    >
                      <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center text-white text-sm font-black shadow-sm shrink-0">
                        {avatarLetter}
                      </div>
                      <div className="text-left">
                    ...
                    {isDropdownOpen && (
                      <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                        <div className="p-4 border-b border-gray-50 flex items-center gap-3 bg-gradient-to-br from-sky-50 to-sky-100">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center text-white font-black text-base shadow-sm shrink-0">
                            {avatarLetter}
                          </div>
        ...
        <div className="flex-1 overflow-y-auto flex flex-col">
          ...
          {isLoggedIn && (
            <div className="mx-4 mt-2 mb-1 p-3 rounded-2xl flex items-center gap-3 bg-gradient-to-br from-sky-50 to-sky-100">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center text-white font-black text-sm shrink-0">
                {avatarLetter}
              </div>
              <div className="overflow-hidden">
...
//               {/* Wishlist */}
//               <Link to="/my-list" className="mh-wish-btn hidden lg:flex w-10 h-10 rounded-2xl border border-gray-100 bg-gray-50 items-center justify-center relative transition-all duration-200">
//                 <Heart size={18} className={myListCount > 0 ? "text-rose-500" : "text-gray-400"} />
//                 {myListCount > 0 && (
