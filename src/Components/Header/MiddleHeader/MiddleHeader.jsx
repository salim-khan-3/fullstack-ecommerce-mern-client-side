...
const MiddleHeader = () => {
  ...
  const guardedNavigate = useRequireAuth();
  ...
  // Avatar UI — reusable
  const AvatarButton = ({ size = "sm" }) => (
    <div
      className={`
      ${size === "sm" ? "w-8 h-8 text-sm" : "w-9 h-9 text-base"}
      rounded-xl bg-gradient-to-br from-sky-400 to-blue-600
      flex items-center justify-center text-white font-black shadow-sm shrink-0 overflow-hidden
    `}
    >
      {user?.image ? (
        <img
  ...
  return (
    <>
      ...
      <div className="bg-white w-full sticky top-0 z-[110] border-b border-gray-100 shadow-sm">
        <div className="container mx-auto px-5">
          <div className="flex items-center gap-4 py-3.5">
            ...
            {/* Location */}
            <button
              className="hidden xl:flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl border border-gray-100 bg-gray-50 shrink-0 hover:bg-sky-50 hover:border-sky-200 transition-all duration-200"
              style={{ minWidth: 160 }}
            >
            ...
            <div className="flex items-center gap-2 shrink-0 ml-auto">
              ...
              >
                <Heart
                  size={18}
                  className={
                    myListCount > 0 ? "text-rose-500" : "text-gray-400"
                  }
                />
                {myListCount > 0 && (
              ...
              <button
                ...
                className="flex items-center gap-2.5 pl-2.5 pr-4 py-2 rounded-2xl transition-all duration-200"
              >
                <div className="relative w-8 h-8 rounded-xl bg-white flex items-center justify-center shrink-0 border border-gray-100 shadow-sm">
              ...
              {/* ── MOBILE: Profile Icon (menu এর বামে) ── */}
                ...
                {isLoggedIn ? (
                  <>
                    <button
                      ...
                      className="w-10 h-10 rounded-2xl border border-gray-100 bg-gray-50 flex items-center justify-center hover:bg-sky-50 hover:border-sky-200 transition-all duration-200 overflow-hidden"
                    >
                      {user?.image ? (
                        <img
                          src={user.image}
                        ...
                        <div className="w-full h-full rounded-2xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center text-white font-black text-sm">
                          {avatarLetter}
                        </div>
                      )}
                    </button>
                    ...
                    {isMobileDropdownOpen && (
                      <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-[150]">
                        {/* Header */}
                        <div className="p-4 border-b border-gray-50 flex items-center gap-3 bg-gradient-to-br from-sky-50 to-sky-100">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center text-white font-black text-base shrink-0 overflow-hidden">
                            {user?.image ? (
                              <img
                                src={user.image}
                                alt="avatar"
                  ...
                  // Login না থাকলে Sign In icon দেখাও
                  <Link
                    to="/login"
                    className="w-10 h-10 rounded-2xl border border-gray-100 bg-gray-50 flex items-center justify-center hover:bg-sky-50 hover:border-sky-200 transition-all duration-200"
                  >
      ...
      {/* ── MOBILE SIDEBAR ── */}
      <div
        className={`fixed top-0 right-0 h-full w-[300px] bg-white z-[130] shadow-2xl lg:hidden flex flex-col transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "translate-x-full"}`}
      >
