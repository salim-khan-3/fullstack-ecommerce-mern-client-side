                  ...
                  <>
                    ...
                    {isMobileDropdownOpen && (
                      <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-[150]">
                        ...
                        {/* Menu Items */}
                        <div className="p-2">
                          <Link to="/my-account" onClick={() => setIsMobileDropdownOpen(false)}
                            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors font-medium">
                            <UserCircle size={15} /> My Account
                          </Link>
                          <Link to="/orders" onClick={() => setIsMobileDropdownOpen(false)}
                            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors font-medium">
                            <Package size={15} /> Orders
                          </Link>
                          <Link to="/my-list" onClick={() => setIsMobileDropdownOpen(false)}
                            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors font-medium">
                            <Heart size={15} /> My List
                          </Link>
                          <div className="border-t border-gray-100 mt-1 pt-1">
