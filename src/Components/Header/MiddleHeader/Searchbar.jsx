...
const SearchBar = () => {
  ...
  return (
    <div className={`hidden md:flex flex-1 rounded-2xl overflow-hidden border bg-gray-50 transition-all duration-200 ${focused ? "border-sky-400 ring-2 ring-sky-100" : "border-gray-200"}`}>
      ...
      <button className="m-1.5 px-5 py-2 rounded-xl text-white text-[12px] font-bold flex items-center gap-1.5 shrink-0 transition-all active:scale-95 bg-gradient-to-r from-sky-400 to-blue-600">
        Search
      </button>
    </div>
  );
