    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", height: "215px", background: "#f7f5f2", overflow: "hidden" }}>
          ...
          {/* ✅ Quick View hover overlay — onClick fixed */}
          <div style={{
            ...
            <button
              ...
              onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,255,255,0.96)"; e.currentTarget.style.color = "#0a0a0a"; }}
            >
